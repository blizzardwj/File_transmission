...
Usage:
    python file_transfer_app.py --config config_sender.yml    # Run as sender 
    python file_transfer_app.py --config config_receiver.yml  # Run as receiver
...
from core.file_transfer_app import ObserverContext
    ...
    def _client_file_exchange(self, jump_server: str, remote_port: int, 
        ...
        with ObserverContext(transfer, observer):
            try:
                ...
                if file_to_send:
                    success = self._send_file_to_server(transfer, sock, buffer_manager, latency, 
                ...
                # Get a file if requested  
                    ...
                    success = self._receive_file_from_server(transfer, sock, buffer_manager, latency,
